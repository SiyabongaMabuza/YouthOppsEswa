...
<%@ page import="edu.skidmore.cs276.project.webapps.web.JobsServlet"%>
...
<head>
   <meta charset="UTF-8">
   <title>Jobs & Internships - Eswatini Youth Resources</title>
   <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/style.css">
</head>
<body>
   <h1>Jobs & Internship Opportunities</h1>
   <p>Jobs & Internships available.</p>
   <ul>
    <%
    List<String[]> resources = (List<String[]>) request.getAttribute("jobs");
    ...
    if (resources != null && !resources.isEmpty()) {
        ...
        for (String[] resource : resources) {
            ...
            out.println("<td><a href=\"" + resource[1] + "\">" + resource[1] + "</a></td>"); // URL as clickable link
            ...
            if ("admin".equals(role)) {
                ...
                out.println("<input type=\"hidden\" name=\"" + RequestParameter.CATEGORY.getKey() + "\" value=\"jobs\">");
                out.println("<input type=\"hidden\" name=\"" + RequestParameter.RESOURCE_URL.getKey() + "\" value=\"" + resource[1] + "\">");
                out.println("<input type=\"hidden\" name=\"returnPath\" value=\"" + request.getContextPath() + "/jobs\">");
        ...
        out.println("<p>No jobs added yet.</p>");
    }
%>
   </ul>
