...
<head>
   <meta charset="UTF-8">
   <title>Grants - Eswatini Youth Resources</title>
...
<body>
   ...
   <%
    List<String[]> resources = (List<String[]>) request.getAttribute("grants");
    ...
    if (resources != null && !resources.isEmpty()) {
        ...
        for (String[] resource : resources) {
            ...
            if ("admin".equals(role)) {
                ...
                out.println("<input type=\"hidden\" name=\"" + RequestParameter.CATEGORY.getKey() + "\" value=\"grants\">");
                out.println("<input type=\"hidden\" name=\"" + RequestParameter.RESOURCE_URL.getKey() + "\" value=\"" + resource[1] + "\">");
                out.println("<input type=\"hidden\" name=\"returnPath\" value=\"" + request.getContextPath() + "/grants\">");
        ...
        out.println("<p>No grants added yet.</p>");
    }
   %>
